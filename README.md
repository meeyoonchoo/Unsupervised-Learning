...
data = pd.read_csv(r"C:\Users\meeyoonchoo\Documents\BayPath\DataMining2/Mall_Customers.csv")
...
<div>
            ...
            <div id="9d4ac6e5-0c42-4927-beb1-42ed6a59b931" class="plotly-graph-div" style="height:230px; width:100%;"></div>
            <script type="text/javascript">
                require(["plotly"], function(Plotly) {
                    window.PLOTLYENV=window.PLOTLYENV || {};
                    
                if (document.getElementById("9d4ac6e5-0c42-4927-beb1-42ed6a59b931")) {
                    Plotly.newPlot(
                        '9d4ac6e5-0c42-4927-beb1-42ed6a59b931',
...
var gd = document.getElementById('9d4ac6e5-0c42-4927-beb1-42ed6a59b931');
...
<div>
            ...
            <div id="867eff85-5919-4fb3-bd4d-58ba139d1c4e" class="plotly-graph-div" style="height:320px; width:100%;"></div>
            <script type="text/javascript">
                require(["plotly"], function(Plotly) {
                    window.PLOTLYENV=window.PLOTLYENV || {};
                    
                if (document.getElementById("867eff85-5919-4fb3-bd4d-58ba139d1c4e")) {
                    Plotly.newPlot(
                        '867eff85-5919-4fb3-bd4d-58ba139d1c4e',
...
var gd = document.getElementById('867eff85-5919-4fb3-bd4d-58ba139d1c4e');
var x = new MutationObserver(function (mutations, observer) {{
        var display = window.getComputedStyle(gd).display;
        if (!display || display === 'none') {{
            console.log([gd, 'removed!']);
...
<div>
            ...
            <div id="4eed3b4e-5ef4-488a-986b-620d6537c94e" class="plotly-graph-div" style="height:525px; width:100%;"></div>
            <script type="text/javascript">
                require(["plotly"], function(Plotly) {
                    window.PLOTLYENV=window.PLOTLYENV || {};
                    
                if (document.getElementById("4eed3b4e-5ef4-488a-986b-620d6537c94e")) {
                    Plotly.newPlot(
                        '4eed3b4e-5ef4-488a-986b-620d6537c94e',
...
var gd = document.getElementById('4eed3b4e-5ef4-488a-986b-620d6537c94e');
var x = new MutationObserver(function (mutations, observer) {{
        var display = window.getComputedStyle(gd).display;
        if (!display || display === 'none') {{
            console.log([gd, 'removed!']);
